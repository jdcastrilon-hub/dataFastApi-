...
class Articulo(Base):
    ...
    codigosBarraM = relationship("CodigosBarraModel", back_populates="articulo")
...
class CodigosBarra(Base): 
    ...
    registro_nuevo = Column(Boolean, default=True)
...
class CodigosBarraModel(Base): 
    ...
    # Definimos los campos que forman la clave primaria compuesta
    id_codbarra = Column(Integer,primary_key=True,nullable=False)
    id_articulo = Column(Integer,ForeignKey("public.m_articulos.id_articulo"),primary_key=True,nullable=False)    
    ...
    # Referecia para articulo
    articulo = relationship("Articulo", back_populates="codigosBarraM")
